...
(function (e) {
  ...
  e.ui.plugin = {
    ...
    call: function (e, t, i, s) {
      var n, a = e.plugins[t]
            if (a && (s || e.element[0].parentNode && e.element[0].parentNode.nodeType !== 11))
    ...
    _create: function () {
      ...
      this.hasTitle = !!this.buttonElement.attr('title')
            var t = this,
               ...
               n = s ? '' : 'ui-state-active';
      i.label === null && (i.label = 'input' === this.type ? this.buttonElement.val() : this.buttonElement.html()),
  ...
  e.extend(e.ui, {
    ...
    _optionDatepicker: function (t, i, s) {
      var n, a, o, h, l = this._getInst(t)
            return arguments.length === 2 && 'string' === typeof i ? 'defaults' === i ? e.extend({}, e.datepicker._defaults) : l ? 'all' === i ? e.extend({}, l.settings) : this._get(l, i) : null : (n = i || {},
      'string' === typeof i && (n = {},
      n[i] = s),
      ...
      r(l.settings, n),
      o !== null && void 0 !== n.dateFormat && void 0 === n.minDate && (l.settings.minDate = this._formatDate(l, o)),
      h !== null && void 0 !== n.dateFormat && void 0 === n.maxDate && (l.settings.maxDate = this._formatDate(l, h)),
    ...
    _doKeyPress: function (t) {
      ...
      s = String.fromCharCode(t.charCode == null ? t.keyCode : t.charCode),
    ...
    _updateDatepicker: function (t) {
      ...
      t.dpDiv[(s[0] !== 1 || s[1] !== 1 ? 'add' : 'remove') + 'Class']('ui-datepicker-multi'),
    ...
    _findPos: function (t) {
      for (var i, s = this._getInst(t), n = this._get(s, 'isRTL'); t && ('hidden' === t.type || t.nodeType !== 1 || e.expr.filters.hidden(t));)
    ...
    parseDate: function (t, i, s) {
      ...
      if (m === -1 ? m = (new Date()).getFullYear() : m < 100 && (m += (new Date()).getFullYear() - (new Date()).getFullYear() % 100 + (u >= m ? 0 : -100)),
      y > -1)
        {for (g = 1,
                v = y; ; ) {
    ...
    _determineDate: function (t, i, s) {
      var n = function (e) {
          ...
          return new Date(a, o, r)
               ...
               o = i == null || '' === i ? s : 'string' === typeof i ? a(i) : 'number' === typeof i ? isNaN(i) ? s : n(i) : new Date(i.getTime())
    ...
    _generateHTML: function (e) {
      var t, i, s, n, a, o, r, h, l, u, d, c, p, f, m, g, v, y, b, _, x, w, k, T, D, S, M, C, N, A, P, I, H, z, F, E, O, j, W, L = new Date(), R = this._daylightSavingAdjust(new Date(L.getFullYear(), L.getMonth(), L.getDate())), Y = this._get(e, 'isRTL'), B = this._get(e, 'showButtonPanel'), J = this._get(e, 'hideIfNoPrevNext'), q = this._get(e, 'navigationAsDateFormat'), K = this._getNumberOfMonths(e), V = this._get(e, 'showCurrentAtPos'), U = this._get(e, 'stepMonths'), Q = K[0] !== 1 || K[1] !== 1, G = this._daylightSavingAdjust(e.currentDay ? new Date(e.currentYear, e.currentMonth, e.currentDay) : new Date(9999, 9, 9)), X = this._getMinMaxDate(e, 'min'), $ = this._getMinMaxDate(e, 'max'), Z = e.drawMonth - V, et = e.drawYear
            if (Z < 0 && (Z += 12,
      et--),
      $)
      ...
      w = 0; K[0] > w; w++) {
        ...
        T = 0; K[1] > T; T++) {
          ...
          for (M += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && w === 0 ? Y ? a : s : '') + (/all|right/.test(S) && w === 0 ? Y ? s : a : '') + this._generateMonthYearHeader(e, Z, et, X, $, w > 0 || T > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead>" + '<tr>',
    ...
    _getNumberOfMonths: function (e) {
      var t = this._get(e, 'numberOfMonths')
            return t == null ? [1, 1] : 'number' === typeof t ? [1, t] : t
    },
  ...
  e.fn.datepicker = function (t) {
    ...
    e("#" + e.datepicker._mainDivId).length === 0 && e('body').append(e.datepicker.dpDiv)
        ...
        return 'string' !== typeof t || 'isDisabled' !== t && 'getDate' !== t && 'widget' !== t ? 'option' === t && arguments.length === 2 && 'string' === typeof arguments[1] ? e.datepicker['_' + t + 'Datepicker'].apply(e.datepicker, [this[0]].concat(i)) : this.each(function () {
  ...
  e.ui.plugin.add('resizable', 'grid', {
    resize: function () {
      ...
      i.size.height = f,
      i.position.left = o.left - d) : ((f - u <= 0 || p - l <= 0) && (t = i._getPaddingPlusBorderDimensions(this)),
  ...
  e.effects.effect.scale = function (t, i) {
    var s = e(this),
           ...
           o = parseInt(t.percent, 10) || (parseInt(t.percent, 10) === 0 ? 0 : 'hide' === a ? 0 : 100),
           r = t.direction || 'both',
           h = t.origin,
           l = {
        height: s.height(),
  ...
  e.widget('ui.slider', e.ui.mouse, {
    ...
    _slide: function (e, t, i) {
      ...
      this.options.values.length === 2 && this.options.range === !0 && (t === 0 && i > s || t === 1 && s > i) && (i = s),
    ...
    _refreshValue: function () {
      var t, i, s, n, a, o = this.options.range, r = this.options, h = this, l = this._animateOff ? !1 : r.animate, u = {}
        ...
        h.options.range === !0 && ('horizontal' === h.orientation ? (s === 0 && h.range.stop(1, 1)[l ? 'animate' : 'css']({
          left: i + '%'
        }, r.animate),
        s === 1 && h.range[l ? 'animate' : 'css']({
          width: i - t + '%'
        }, {
          queue: !1,
          duration: r.animate
        })) : (s === 0 && h.range.stop(1, 1)[l ? 'animate' : 'css']({
          bottom: i + '%'
        }, r.animate),
        s === 1 && h.range[l ? 'animate' : 'css']({
          height: i - t + '%'
  ...
  e.widget('ui.spinner', {
    ...
    _adjustValue: function (e) {
      var t, i, s = this.options
            return t = s.min !== null ? s.min : 0,
      i = e - t,
      i = Math.round(i / s.step) * s.step,
      e = t + i,
      e = parseFloat(e.toFixed(this._precision())),
      s.max !== null && e > s.max ? s.max : s.min !== null && s.min > e ? s.min : e
    },
    _stop: function (e) {
  ...
  e.widget('ui.tabs', {
    ...
    _initialActive: function () {
      var t = this.options.active,
            ...
            return t === null && (s && this.tabs.each(function (i, n) {
    ...
    _findNextTab: function (t, i) {
      ...
      for (var n = this.tabs.length - 1; e.inArray(s(), this.options.disabled) !== -1;)
        {t = i ? t + 1 : t - 1;}
      return t
    },
