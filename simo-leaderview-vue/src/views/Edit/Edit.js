...
let config = {
  ...
  WGYPot: require('@/components/EditComp/WGYPot/config.js'),
  CYMap: require('@/components/EditComp/CYMap/config.js'),
  SMMap: require('@/components/EditComp/SMMap/config.js'),
  ...
  StreetSafety: require('@/components/EditComp/StreetSafety/config.js'),
