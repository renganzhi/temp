      ...
      <div class="content">
          <div class="personBox" @click="ShowPop1">
              ...
              <div class="information1">
                  ...
                  <div>
                      <div>{{getZBRY('区领导','姓名')}}<img style="cursor:pointer;width:20px;height:20px;vertical-align:sub;margin-left:5px;" src="./短信.png" @click.stop="ShowText(0)" alt=""></div>
          ...
          <div class="personBox" @click="ShowPop1">
              ...
              <div class="information2">
                  <div>
                    ...
                    <img style="cursor:pointer;width:20px;height:20px;vertical-align:sub;margin-left:0px;" src="./短信.png" @click.stop="ShowText(1)" alt="">
                  </div>
          ...
          <div class="personBox" @click="ShowPop1">
              ...
              <div class="information2">
                  <div>
                    ...
                    <img style="cursor:pointer;width:20px;height:20px;vertical-align:sub;margin-left:0px;" src="./短信.png" @click.stop="ShowText(2)" alt="">
                  </div>
                    ...
                    <div class="personnelInfo">
                      ...
                      <div>
                        <div class="name">{{element['领导姓名']}}
                          ...
                          <img style="cursor:pointer;width:24px;height:24px;vertical-align:baseline;margin-left:0px;" src="./短信.png" @click.stop="textIndex2 = index" alt="">
                        </div>
